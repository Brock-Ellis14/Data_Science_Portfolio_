...
💻 Tech StackStatistical Modeling:

Python (statsmodels, scipy), R (tidyverse).Data Engineering: SQL (SQLite), Pandas, NumPy.Visualization: ggplot2, lets-plot, Matplotlib.Documentation: LaTeX for formal mathematical reporting.
