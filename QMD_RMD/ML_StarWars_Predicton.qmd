...
(
    ...
    facet_wrap("income") +
    labs(
        title="Distribution of The Levels of Age, Gender, & 50k Income Level",
...
model_scores = pd.DataFrame({
    ...
    'Accuracy': [0.696, 0.684, 0.653, 0.583, 0.351]
})
...
ggplot(top_features, aes(x='Features', y='Importance Level', fill='Feature')) + \
