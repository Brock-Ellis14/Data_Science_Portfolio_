...
First, I looked at the columns and their datatypes. 
```{python}
# Recode age to midpoints or random beac
age_map = {
    '18-29': 23,
    '30-44': 37,
    '45-60': 52.5
...
df.loc[mask, 'age'] = np.random.randint(60, 72, size=mask.sum())
```
